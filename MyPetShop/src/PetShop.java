...
public class PetShop {
	...
	private HashMap<String, Integer> dogBreeds = new HashMap<>();
	private HashMap<String, Integer> catBreeds = new HashMap<>();
	private HashMap<String, Integer> fishBreeds = new HashMap<>();
	private HashMap<String, Integer> turtleBreeds = new HashMap<>();
	...
	public void loadPets() {
		...
		for (Pet dog : dogs) {
			dogBreeds.put(dog.getBreed(), dogBreeds.getOrDefault(dog.getBreed(), 0) + 1);
		}
		for (Pet cat : cats) {
			catBreeds.put(cat.getBreed(), catBreeds.getOrDefault(cat.getBreed(), 0) + 1);
		}
		for (Pet turtle : turtles) {
			turtleBreeds.put(turtle.getBreed(), turtleBreeds.getOrDefault(turtle.getBreed(), 0) + 1);
		}
		for (Pet fish : fishes) {
			fishBreeds.put(fish.getBreed(), fishBreeds.getOrDefault(fish.getBreed(), 0) + 1);
		}
	...
	public void printInventorySummary() {
		System.out.printf("%-20s%s", "Dog Breed", "Amount");
		System.out.println("\n==========================");
		for (String breed : dogBreeds.keySet()) {
			System.out.printf("%-20s%d", breed, dogBreeds.get(breed));
			System.out.println();
		}
		System.out.printf("\n%-20s%s", "Cat Breed", "Amount");
		System.out.println("\n==========================");
		for (String breed : catBreeds.keySet()) {
			System.out.printf("%-20s%d", breed, catBreeds.get(breed));
			System.out.println();
		}
		System.out.printf("\n%-20s%s", "Turtle Breed", "Amount");
		System.out.println("\n==========================");
		for (String breed : turtleBreeds.keySet()) {
			System.out.printf("%-20s%d", breed, turtleBreeds.get(breed));
			System.out.println();
		}
		System.out.printf("\n%-20s%s", "Fish Breed", "Amount");
		System.out.println("\n==========================");
		for (String breed : fishBreeds.keySet()) {
			System.out.printf("%-20s%d", breed, fishBreeds.get(breed));
			System.out.println();
		}
	}
